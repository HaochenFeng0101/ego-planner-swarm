...
multi_map_server__msg__MultiOccupancyGrid__get_type_hash(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  static rosidl_type_hash_t hash = {1, {
      0x26, 0x2c, 0xc6, 0x0a, 0x84, 0xde, 0x2e, 0xd3,
      0x9d, 0x32, 0x0e, 0xb7, 0x5b, 0x7a, 0x32, 0x12,
      0x9f, 0xa2, 0xd1, 0x6b, 0xee, 0x47, 0x16, 0x55,
      0x8c, 0xe2, 0x10, 0x2e, 0xe3, 0xf4, 0xec, 0x50,
    }};
  return &hash;
}
...
static char multi_map_server__msg__MultiOccupancyGrid__TYPE_NAME[] = "multi_map_server/msg/MultiOccupancyGrid";
...
static char multi_map_server__msg__MultiOccupancyGrid__FIELD_NAME__maps[] = "maps";
static char multi_map_server__msg__MultiOccupancyGrid__FIELD_NAME__origins[] = "origins";

static rosidl_runtime_c__type_description__Field multi_map_server__msg__MultiOccupancyGrid__FIELDS[] = {
  {
    {multi_map_server__msg__MultiOccupancyGrid__FIELD_NAME__maps, 4, 4},
    {
  ...
  {
    {multi_map_server__msg__MultiOccupancyGrid__FIELD_NAME__origins, 7, 7},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription multi_map_server__msg__MultiOccupancyGrid__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
...
multi_map_server__msg__MultiOccupancyGrid__get_type_description(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {multi_map_server__msg__MultiOccupancyGrid__TYPE_NAME, 39, 39},
      {multi_map_server__msg__MultiOccupancyGrid__FIELDS, 2, 2},
    },
    {multi_map_server__msg__MultiOccupancyGrid__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
multi_map_server__msg__MultiOccupancyGrid__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
...
multi_map_server__msg__MultiOccupancyGrid__get_type_description_sources(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *multi_map_server__msg__MultiOccupancyGrid__get_individual_type_description_source(NULL),
