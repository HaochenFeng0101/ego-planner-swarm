...
bool multi_map_server__msg__multi_sparse_map3_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_map_server.msg._multi_sparse_map3_d", (char *)PyUnicode_1BYTE_DATA(module_attr), 41) == 0);
    assert(strncmp("MultiSparseMap3D", (char *)PyUnicode_1BYTE_DATA(name_attr), 16) == 0);
