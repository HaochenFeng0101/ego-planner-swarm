...
bool multi_map_server__msg__multi_occupancy_grid__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("multi_map_server.msg._multi_occupancy_grid", (char *)PyUnicode_1BYTE_DATA(module_attr), 42) == 0);
    assert(strncmp("MultiOccupancyGrid", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
