...
bool quadrotor_msgs__msg__trpy_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._trpy_command", (char *)PyUnicode_1BYTE_DATA(module_attr), 32) == 0);
    assert(strncmp("TRPYCommand", (char *)PyUnicode_1BYTE_DATA(name_attr), 11) == 0);
