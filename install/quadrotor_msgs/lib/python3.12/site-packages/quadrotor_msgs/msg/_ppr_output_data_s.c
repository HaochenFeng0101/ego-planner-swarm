...
bool quadrotor_msgs__msg__ppr_output_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._ppr_output_data", (char *)PyUnicode_1BYTE_DATA(module_attr), 35) == 0);
    assert(strncmp("PPROutputData", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
