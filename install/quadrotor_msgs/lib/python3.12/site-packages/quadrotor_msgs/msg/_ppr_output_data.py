...
class Metaclass_PPROutputData(type):
    ...
    class PPROutputDataConstants(typing.TypedDict):
        pass

    __constants: PPROutputDataConstants = {
    }
...
class PPROutputData(metaclass=Metaclass_PPROutputData):
    ...
    def __init__(self, *,
                 ...
                 quad_time: typing.Optional[int] = None,  # noqa: E501
                 des_thrust: typing.Optional[float] = None,  # noqa: E501
                 des_roll: typing.Optional[float] = None,  # noqa: E501
                 des_pitch: typing.Optional[float] = None,  # noqa: E501
                 des_yaw: typing.Optional[float] = None,  # noqa: E501
                 est_roll: typing.Optional[float] = None,  # noqa: E501
                 est_pitch: typing.Optional[float] = None,  # noqa: E501
                 est_yaw: typing.Optional[float] = None,  # noqa: E501
                 est_angvel_x: typing.Optional[float] = None,  # noqa: E501
                 est_angvel_y: typing.Optional[float] = None,  # noqa: E501
                 est_angvel_z: typing.Optional[float] = None,  # noqa: E501
                 est_acc_x: typing.Optional[float] = None,  # noqa: E501
                 est_acc_y: typing.Optional[float] = None,  # noqa: E501
                 est_acc_z: typing.Optional[float] = None,  # noqa: E501
                 pwm: typing.Optional[typing.Union[numpy.typing.NDArray[numpy.uint16], collections.abc.Sequence[int], collections.abc.Set[int], collections.UserList[int]]] = None,  # noqa: E501
        ...
        self.quad_time = quad_time if quad_time is not None else int()
        self.des_thrust = des_thrust if des_thrust is not None else float()
        self.des_roll = des_roll if des_roll is not None else float()
        self.des_pitch = des_pitch if des_pitch is not None else float()
        self.des_yaw = des_yaw if des_yaw is not None else float()
        self.est_roll = est_roll if est_roll is not None else float()
        self.est_pitch = est_pitch if est_pitch is not None else float()
        self.est_yaw = est_yaw if est_yaw is not None else float()
        self.est_angvel_x = est_angvel_x if est_angvel_x is not None else float()
        self.est_angvel_y = est_angvel_y if est_angvel_y is not None else float()
        self.est_angvel_z = est_angvel_z if est_angvel_z is not None else float()
        self.est_acc_x = est_acc_x if est_acc_x is not None else float()
        self.est_acc_y = est_acc_y if est_acc_y is not None else float()
        self.est_acc_z = est_acc_z if est_acc_z is not None else float()
        if pwm is None:
            self.pwm = numpy.zeros(4, dtype=numpy.uint16)
        else:
            self.pwm = numpy.array(pwm, dtype=numpy.uint16)
    ...
    def __eq__(self, other: object) -> bool:
        if not isinstance(other, PPROutputData):
            return False
    ...
    @builtins.property
    def quad_time(self) -> int:
        """Message field 'quad_time'."""
        return self._quad_time

    @quad_time.setter
    def quad_time(self, value: int) -> None:
        if self._check_fields:
            assert \
    ...
    @builtins.property
    def des_thrust(self) -> float:
        """Message field 'des_thrust'."""
        return self._des_thrust

    @des_thrust.setter
    def des_thrust(self, value: float) -> None:
        if self._check_fields:
            assert \
    ...
    @builtins.property
    def des_roll(self) -> float:
        """Message field 'des_roll'."""
        return self._des_roll

    @des_roll.setter
    def des_roll(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def des_pitch(self) -> float:
        """Message field 'des_pitch'."""
        return self._des_pitch

    @des_pitch.setter
    def des_pitch(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def des_yaw(self) -> float:
        """Message field 'des_yaw'."""
        return self._des_yaw

    @des_yaw.setter
    def des_yaw(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_roll(self) -> float:
        """Message field 'est_roll'."""
        return self._est_roll

    @est_roll.setter
    def est_roll(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_pitch(self) -> float:
        """Message field 'est_pitch'."""
        return self._est_pitch

    @est_pitch.setter
    def est_pitch(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_yaw(self) -> float:
        """Message field 'est_yaw'."""
        return self._est_yaw

    @est_yaw.setter
    def est_yaw(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_angvel_x(self) -> float:
        """Message field 'est_angvel_x'."""
        return self._est_angvel_x

    @est_angvel_x.setter
    def est_angvel_x(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_angvel_y(self) -> float:
        """Message field 'est_angvel_y'."""
        return self._est_angvel_y

    @est_angvel_y.setter
    def est_angvel_y(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_angvel_z(self) -> float:
        """Message field 'est_angvel_z'."""
        return self._est_angvel_z

    @est_angvel_z.setter
    def est_angvel_z(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_acc_x(self) -> float:
        """Message field 'est_acc_x'."""
        return self._est_acc_x

    @est_acc_x.setter
    def est_acc_x(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_acc_y(self) -> float:
        """Message field 'est_acc_y'."""
        return self._est_acc_y

    @est_acc_y.setter
    def est_acc_y(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def est_acc_z(self) -> float:
        """Message field 'est_acc_z'."""
        return self._est_acc_z

    @est_acc_z.setter
    def est_acc_z(self, value: float) -> None:
        if self._check_fields:
            assert \
                isinstance(value, float), \
    ...
    @builtins.property
    def pwm(self) -> typing.Annotated[typing.Any, numpy.typing.NDArray[numpy.uint16]]:   # typing.Annotated can be remove after mypy 1.16+ see mypy#3004
        """Message field 'pwm'."""
        return self._pwm

    @pwm.setter
    def pwm(self, value: typing.Union[numpy.typing.NDArray[numpy.uint16], collections.abc.Sequence[int], collections.abc.Set[int], collections.UserList[int]]) -> None:
        if self._check_fields:
