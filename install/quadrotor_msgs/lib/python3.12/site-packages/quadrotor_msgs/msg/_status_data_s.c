...
bool quadrotor_msgs__msg__status_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._status_data", (char *)PyUnicode_1BYTE_DATA(module_attr), 31) == 0);
    assert(strncmp("StatusData", (char *)PyUnicode_1BYTE_DATA(name_attr), 10) == 0);
