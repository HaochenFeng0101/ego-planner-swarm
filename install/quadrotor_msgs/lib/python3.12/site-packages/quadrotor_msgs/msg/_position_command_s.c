...
bool quadrotor_msgs__msg__position_command__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._position_command", (char *)PyUnicode_1BYTE_DATA(module_attr), 36) == 0);
    assert(strncmp("PositionCommand", (char *)PyUnicode_1BYTE_DATA(name_attr), 15) == 0);
