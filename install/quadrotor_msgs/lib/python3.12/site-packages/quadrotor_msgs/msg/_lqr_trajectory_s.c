...
bool quadrotor_msgs__msg__lqr_trajectory__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("quadrotor_msgs.msg._lqr_trajectory", (char *)PyUnicode_1BYTE_DATA(module_attr), 34) == 0);
    assert(strncmp("LQRTrajectory", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
