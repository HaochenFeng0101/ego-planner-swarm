...
bool traj_utils__msg__multi_bsplines__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("traj_utils.msg._multi_bsplines", (char *)PyUnicode_1BYTE_DATA(module_attr), 30) == 0);
    assert(strncmp("MultiBsplines", (char *)PyUnicode_1BYTE_DATA(name_attr), 13) == 0);
