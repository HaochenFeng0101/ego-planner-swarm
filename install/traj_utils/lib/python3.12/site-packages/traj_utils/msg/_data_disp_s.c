...
bool traj_utils__msg__data_disp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("traj_utils.msg._data_disp", (char *)PyUnicode_1BYTE_DATA(module_attr), 25) == 0);
    assert(strncmp("DataDisp", (char *)PyUnicode_1BYTE_DATA(name_attr), 8) == 0);

    Py_DECREF(module_attr);
    Py_DECREF(name_attr);
    Py_DECREF(class_attr);
  }
  traj_utils__msg__DataDisp * ros_message = _ros_message;
  {  // header
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * traj_utils__msg__data_disp__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of DataDisp */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("traj_utils.msg._data_disp");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DataDisp");
  ...
  traj_utils__msg__DataDisp * ros_message = (traj_utils__msg__DataDisp *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
